...
public class BetSearcher {
    public static final String BETSEARCHURL = "http://en.mobileapi.bwinlabs.com/api/iphone/v2/events/main?partnerid=test&winninggames=true&topsport=true&page_size=10";
